...
const getCryptosDay = async () => {
    ...
    for (const crypto of cryptoList) {
        const cryptoDayUrl = `https://min-api.cryptocompare.com/data/v2/histoday?fsym=${crypto.symbol}&tsym=${DEVISE}&limit=1&api_key=${API_KEY}`;
...
const getCryptosHour = async () => {
    ...
    for (const crypto of cryptoList) {
        const cryptoHourUrl = `https://min-api.cryptocompare.com/data/v2/histohour?fsym=${crypto.symbol}&tsym=${DEVISE}&limit=1&api_key=${API_KEY}`;
...
const getCryptosMinute = async () => {
    ...
    for (const crypto of cryptoList) {
        const cryptoMinuteUrl = `https://min-api.cryptocompare.com/data/v2/histominute?fsym=${crypto.symbol}&tsym=${DEVISE}&limit=1&api_key=${API_KEY}`;
